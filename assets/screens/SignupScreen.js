...
import { StyleSheet, ScrollView, Text, View, Image, TouchableOpacity, Alert, SafeAreaView} from 'react-native';
...
const SignUpScreen = ({route, navigation}) => {
    ...
    const [type, setType] = useState(enterAs);
    ...
    const signupUser = async (lrnVal, fnameVal, mnameVal, lnameVal, addressVal, emailVal, contactVal, passwordVal) => {
        setIsSigningUp(true);
        try {
    ...
    return isSigningUp ? (
        <View style={{flex: 1, backgroundColor: 'white', padding: 20, alignItems: 'center', justifyContent: 'center'}}>
          <Image source={{uri: 'https://wpamelia.com/wp-content/uploads/2018/11/ezgif-2-6d0b072c3d3f.gif'}} style={{width: '70%', height: 70}} />
          <Text style={{fontSize: 12, fontWeight: 'bold', marginTop: -15}}>Signing Up</Text>
        </View>
    ) : (
          ...
          <View style={styles.formContainer}>
             ...
             <View>
                 <TouchableOpacity  onPress={pickImage}>
                    <Image source={{uri: image !== '' ? image : 'https://www.winhelponline.com/blog/wp-content/uploads/2017/12/user.png'}} style={styles.logoProfile}></Image>
                </TouchableOpacity>
              ...
              <Button 
                ...
                mode="contained" 
                onPress={() => signupUser(lrn, fname, mname, lname, address, email, contact, password)}
              >
                  SIGN UP AS {enterAs}
              </Button>
              <TouchableOpacity 
              ...
              >
              <Text style={styles.appButtonTextSignUp}>Have already an account? <Text style={{color: '#c90632'}}>Sign In</Text></Text>
              </TouchableOpacity>
          </View>
        </ScrollView>
    );
